      ...
      <LeftContainer>
        ...
        <CTAWrapper>
          ...
          <CTATextWrapper>
            ...
            <CTAText>Discover AI assistance</CTAText>
          </CTATextWrapper>
        </CTAWrapper>
        ...
        <UsersContainer>
          <AvatarContainer>
            <AvatarWrapper>
              ...
              <Avatar>
                <AvatarImage src="../../src/assets/avatar3.png" />
              </Avatar>
              <Avatar>
                <AvatarImage src="../../src/assets/avatar4.png" />
              </Avatar>
            </AvatarWrapper>
          </AvatarContainer>
        ...
        <ImagesContainer>
          <ImagesRow>
            <ImageWrapper background="#FF9C66">
              <Image src="../../src/assets/image21.png" />
            </ImageWrapper>
            <ImageWrapper background="#D6BBFB">
              <Image src="../../src/assets/image100.png" />
            </ImageWrapper>
            <ImageWrapper background="#ACDC79">
              <Image src="../../src/assets/image8.png" />
            </ImageWrapper>
          </ImagesRow>
          <ImagesRow>
            <ImageWrapper background="#B3B8DB">
              <Image src="../../src/assets/image72.png" />
            </ImageWrapper>
            <ImageWrapper background="#FEC84B">
              <Image src="../../src/assets/image108.png" />
            </ImageWrapper>
            <ImageWrapper background="#FEA3B4">
              <Image src="../../src/assets/image103.png" />
            </ImageWrapper>
          </ImagesRow>
        </ImagesContainer>
      </RightContainer>
